...
public class RedisKeyUtil {
	 ...
	 */
	private static final String RESET_PWD_TOKEN_KEY = "gbdpboot:restPwd";
	private static final String ACTIVE_USER = "gbdpboot:activeUser";
//	private static final String SEND_SMS_COUNT = "gbdpcloud:sms:count";
//	private static final String SEND_EMAIL_CODE = "gbdpcloud:email:code";
	private static final String ACCESS_TOKEN = "gbdpboot:token:accessToken";
	private static final String UPLOAD_FILE_SIZE = "gbdpboot:file:upload_file_size";
