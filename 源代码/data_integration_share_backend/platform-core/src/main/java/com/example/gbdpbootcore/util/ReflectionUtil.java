...
public class ReflectionUtil {
	...
	/**
	 * @description 通过field名称获取对应的Field（子类+父类）
	 * @param modelClass class type
	 * @param fieldName field名称
	 * @return Field
	 * @throws NoSuchFieldException 当子类和父类都没有此属性时抛出异常
	 * @author kwc
	 */
	public static <T> Field getFieldByName(Class<T> modelClass, String fieldName) throws NoSuchFieldException {

		Field field;
		try {
			field = modelClass.getSuperclass().getDeclaredField(fieldName);
