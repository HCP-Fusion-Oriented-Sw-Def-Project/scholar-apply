...
//	 1001 用户中心
	 ...
	 */
	UAC10011042(10011042, "证书过期"),
	/**
	 * Uac 10011043 error code enum.
	 */
	UAC10011043(10011043, "账户过期"),
	/**
	 * Uac 10011044 error code enum.
	 */
	UAC10011044(10011044, "账户过期"),
	/**
	 * Uac 10011045 error code enum.
	 */
	UAC10011045(10011045, "账户被锁定"),
	/**
	 * Uac 10011046 error code enum.
	 */
	UAC10011046(10011046, "用户已被禁用"),
	/**
	...
	UAC10015010(10015010, "存在重复记录！插入失败"),

	UAC10015011(10015011, "记录不存在！请检查参数"),

	UAC10015012(40104, "登陆失败！"),

	UAC10015013(10015013, "Client验证失败！"),
...
// 1005 任务中心
	...
	TPC100500016(10050016, "错误的请求方式，请确认！"),

	TPC100500017(50008, "用户未登录，请携带正确的token"),
	TPC100500018(50014, "token已过期！"),
	;
