...
package com.example.gbdpbootcore.constant;
...
public class GlobalConstant {
	...
	public static final String ROOT_PREFIX = "gbdpboot";

	public static final int EXCEPTION_CAUSE_MAX_LENGTH = 2048;
	public static final int EXCEPTION_MESSAGE_MAX_LENGTH = 2048;

	public static final String ZK_REGISTRY_SERVICE_ROOT_PATH = "/gbdpboot/registry/service";
	public static final String ZK_REGISTRY_ID_ROOT_PATH = "/gbdpboot/registry/id";
	public static final String ZK_REGISTRY_PRODUCER_ROOT_PATH = "/gbdpboot/registry/producer";
	public static final String ZK_REGISTRY_CONSUMER_ROOT_PATH = "/gbdpboot/registry/consumer";
	public static final String ZK_REGISTRY_SEQ = "/gbdpboot/seq";
	...
	public static final class Sys {
		 ...
		 */
		public static final String DEFAULT_FILE_PATH = "gbdpboot/file/";
