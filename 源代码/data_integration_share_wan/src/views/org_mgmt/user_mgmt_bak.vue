  ...
  <div class="app-container calendar-list-container">
    ...
    <div class="right-container">
      ...
      <div class="filter-container">
        ...
        <el-input v-model="listQuery.phone" class="filter-item" placeholder="电话" @keyup.enter.native="handleFilter" />
        <el-input
    ...
    <el-dialog v-dialogDrag :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" top="10vh">
      <el-form ref="dataForm" :inline="true" :rules="rules" :model="temp" label-position="right" label-width="100px">
        <el-col :span="12">
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        officeName: [{ required: true, message: '请选择归属机构', trigger: ['blur'] }],
