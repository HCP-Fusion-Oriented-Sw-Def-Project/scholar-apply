  ...
  <div class="app-container calendar-list-container">
    <div style=" margin-bottom:5px;">
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <el-tag
              ...
              :type="scope.row.isShow | statusFilter"
            >显示</el-tag>
            <el-tag
        ...
        >
          <template slot-scope="scope">
            <el-tag type="success">{{ scope.row.permission }}</el-tag>
          </template>
        </el-table-column>
    ...
    >
      ...
      >
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="temp.parentIdName"
              class="filter-item"
              @focus="menuChoice=true"
            />
          </el-form-item>
          <el-form-item
            label="名称："
    ...
    >
      ...
      <div
        ...
        class="dialog-footer"
      >
        <el-button @click="menuChoice = false">取消</el-button>
        <el-button
          type="primary"
          @click="getNode(),menuChoice = false"
        >确认</el-button>
      </div>
    </el-dialog>
  </div>
...
import { fetchMenuList, addMenu, deleteMenu, deleteMenus, editMenu } from '@/api/menu'
export default {
  filters: {
    statusFilter(status) {
      const statusMap = {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        url: [{ required: true, message: '请输入链接', trigger: ['blur', 'change'] }],
        permission: [{ required: true, message: '请输入权限标识', trigger: ['blur', 'change'] }],
        parentIdName: [{ required: true, message: '请输入上级机构', trigger: 'change' }]
      },
      temp: {},
      // 编辑或查看菜单
