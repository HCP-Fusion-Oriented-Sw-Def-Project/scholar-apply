  ...
  <div class="app-container calendar-list-container">
    ...
    >
      <el-form
        ...
        label-width="120px"
        style="margin-left:50px;margin-right:50px;height:300px; "
      >
...
import { fetchRoleList, handleUpdateRole, createRole, deleteLogicalRole, addRoleUser, addRoleOffice, deleteRoleUser, deleteRoleInBatches } from '@/api/role'
import { fetchMenuList } from '@/api/menu'
import { fetchUserList, getUseByRoleId } from '@/api/user'
...
export default {
  ...
  data() {
    ...
    var validateDataScope = (rule, value, callback) => {
      if (!this.temp.dataScope) {
    ...
    return {
      ...
      rules: {
        ...
        dataScope: [{ required: true, validator: validateDataScope, trigger: 'change' }]
  ...
  methods: {
    ...
    cancleUserRoleInBatches() {
      ...
      var arrs = this.multipleSelection.join()
      var role_user_delete = {
        userId: arrs,
        roleId: this.roleId
      }
      ...
      //   // this.multipleSelection[i].roles = this.multipleSelection[i].uacRoles
      //   var role_user_delete = {
      //     userId: this.multipleSelection[i],
      //     roleId: this.roleId
      //   }
      //   deleteRoleUser(role_user_delete).then(() => {
      //     // this.getUserRoleList()
