<template>
  <div>
    <el-menu class="navbar" mode="horizontal">
        ...
        <el-dropdown class="avatar-container right-menu-item hover-effect" trigger="click">
          ...
          <el-dropdown-menu slot="dropdown">
            ...
            <el-dropdown-item divided>
              <span style="display:block;" @click="dialogFormVisible = true">个人信息</span>
            </el-dropdown-item>
            <router-link to="/">
              <el-dropdown-item divided>
                {{ $t('navbar.dashboard') }}
            ...
            <el-dropdown-item divided>
              <span style="display:block;" @click="dialogChangePassword = true">修改密码</span>
            </el-dropdown-item>
      ...
      <el-dialog title="个人信息" :visible.sync="dialogFormVisible" top="8vh" :append-to-body="true">
        <el-form ref="dataForm" :rules="rules" :model="userInfo" label-position="right" label-width="90px" style=" margin-left:50px;margin-right:50px;  ">
          <el-form-item label="头像 :">
            ...
            >
              ...
              <div slot="tip" class="el-upload__tip" style="margin-top:-20px">点击图片可更改头像</div>
            </el-upload>
          </el-form-item>
          ...
          <el-form-item label="邮箱 :" prop="email">
            <el-input v-model="userInfo.email" style="width:400px" suffix-icon="el-icon-message" />
          </el-form-item>
          <el-form-item label="电话 :" prop="phone">
            <el-input v-model="userInfo.phone" style="width:400px" suffix-icon="el-icon-phone" />
          </el-form-item>
        </el-form>
        <div slot="footer" class="dialog-footer">
          <el-button @click="dialogFormVisible = false">取消</el-button>
          <el-button type="primary" @click="handleUserInfo">确认</el-button>
        </div>
      </el-dialog>
      <el-dialog title="修改密码" :visible.sync="dialogChangePassword" top="8vh" :append-to-body="true">
        <el-form ref="passwordForm" :rules="passwordRules" :model="password" label-position="right" label-width="90px" style=" margin-left:50px;margin-right:50px;  ">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        name: [{ required: true, message: 'title is required', trigger: ['change', 'blur'] }]
      },
      passwordRules: {
        old: [{ required: true, message: 'password is required', trigger: ['change', 'blur'] }],
        new: [{ required: true, message: 'password is required', trigger: ['change', 'blur'] }]
      },
